...
describe("Collection", () => {
    it("New empty Collection", () => {
        const col = new _1.Collection();
        assert.equal(col.Count, 0);
    });
    it("New Collection from Array", () => {
        const col = new _1.Collection([1, 2, 3, 4, 5]);
    ...
    it("Filter", () => {
        const col = new _1.Collection([1, 2, 1, 2, 1, 2, 1, 2]);
    ...
    it("Sort", () => {
        const col = new _1.Collection([1, 2, 3, 4, 5]);
        assert.equal(col.Count, 5);
        const array = col.Sort((a, b) => a < b ? 1 : a > b ? -1 : 0).GetIterator();
        const num = 5;

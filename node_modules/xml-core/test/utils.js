...
context("utils", () => {
    it("assign", () => {
        const obj = _1.assign({}, { prop1: 1 }, { prop2: 2 }, { prop3: 3 }, { prop3: 4 });
    ...
    context("SelectSingleNode", () => {
        it("Empty", () => {
            const xml = _1.Parse("<root><child/><child/><child/></root>");
            const node = _1.SelectSingleNode(xml, ".//second");
            assert.equal(node === null, true);
        });
        it("First element", () => {
            const xml = _1.Parse(`<root><child attr="1"/><child attr="2"/><child attr="3"/></root>`);
            const node = _1.SelectSingleNode(xml, ".//child");
    ...
    it("SelectNamespaces", () => {
        const xml = _1.Parse(`<root xmlns="html://namespace1"><n1:child xmlns:n1="html://namespace2"/><n2:child xmlns:n2="html://namespace3"/></root>`);
        const namespaces = _1.SelectNamespaces(xml.documentElement);
    ...
    it("Parse/Stringify", () => {
        ...
        const xml = _1.Parse(xmlString);
        const text = _1.Stringify(xml);

...
(function (global, factory) {
	...
	var ObjectIdentifier = function (_BaseBlock9) {
		...
		function ObjectIdentifier() {
			...
			var _this29 = _possibleConstructorReturn(this, (ObjectIdentifier.__proto__ || Object.getPrototypeOf(ObjectIdentifier)).call(this, parameters, LocalObjectIdentifierValueBlock));
	...
	var RSAPublicKey = function () {
		...
		_createClass(RSAPublicKey, [{
			...
			key: 'fromJSON',
			value: function fromJSON(json) {
				if ("n" in json) this.modulus = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64$1(json.n, true)).slice(0, 256) });else throw new Error("Absent mandatory parameter \"n\"");
		...
		_createClass(GeneralName, [{
			...
			value: function toSchema() {
				switch (this.type) {
					...
					case 8:
						{
							var _value9 = new ObjectIdentifier({ value: this.value });
			...
			return Promise.resolve().then(function () {
				if (reference.Uri) {
					...
					if (objectName_1) {
						...
						if (!found_1 && doc) {
							found_1 = XmlObject.GetElementById(doc, objectName_1);
							if (found_1) {
								var el = found_1.cloneNode(true);
								_this.CopyNamespaces(found_1, el, false);
								_this.CopyNamespaces(doc, el, false);
						...
						if (found_1 == null) {
							throw new XmlError(XE.CRYPTOGRAPHIC, "Cannot get object by reference: " + objectName_1);
						}
					}
				}

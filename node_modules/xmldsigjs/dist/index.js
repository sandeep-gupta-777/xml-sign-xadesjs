...
var XmlCanonicalizer = function () {
    function XmlCanonicalizer(withComments, excC14N, propagatedNamespaces) {
        if (propagatedNamespaces === void 0) {
            propagatedNamespaces = new XmlCore.NamespaceManager();
        }
...
var XmlSignatureObject = function (_super) {
    ...
    XmlSignatureObject = tslib_1.__decorate([XmlCore.XmlElement({
        localName: "xmldsig",
...
var XmlSignatureCollection = function (_super) {
    ...
    XmlSignatureCollection = tslib_1.__decorate([XmlCore.XmlElement({
...
var CanonicalizationMethod = function (_super) {
    ...
    CanonicalizationMethod = tslib_1.__decorate([XmlCore.XmlElement({
...
var DataObject = function (_super) {
    ...
    DataObject = tslib_1.__decorate([XmlCore.XmlElement({
...
var DataObjects = function (_super) {
    ...
    DataObjects = tslib_1.__decorate([XmlCore.XmlElement({
...
var DigestMethod = function (_super) {
    ...
    DigestMethod = tslib_1.__decorate([XmlCore.XmlElement({
...
var KeyInfo = function (_super) {
    ...
    KeyInfo = tslib_1.__decorate([XmlCore.XmlElement({
...
var Transform = function (_super) {
    ...
    Transform = tslib_1.__decorate([XmlCore.XmlElement({
...
var Transforms = function (_super) {
    ...
    Transforms = tslib_1.__decorate([XmlCore.XmlElement({
...
var Reference = function (_super) {
    ...
    Reference = tslib_1.__decorate([XmlCore.XmlElement({
...
var References = function (_super) {
    ...
    References = tslib_1.__decorate([XmlCore.XmlElement({
...
var SignatureMethodOther = function (_super) {
    ...
    SignatureMethodOther.prototype.OnLoadXml = function (element) {
        for (var i = 0; i < element.childNodes.length; i++) {
            var node = element.childNodes.item(i);
            if (node.nodeType !== XmlCore.XmlNodeType.Element || node.nodeName === XmlSignature.ElementNames.HMACOutputLength) {
                continue;
            }
    ...
    SignatureMethodOther = tslib_1.__decorate([XmlCore.XmlElement({
        localName: "Other"
...
var SignatureMethod = function (_super) {
    ...
    SignatureMethod = tslib_1.__decorate([XmlCore.XmlElement({
...
var SignedInfo = function (_super) {
    ...
    SignedInfo = tslib_1.__decorate([XmlCore.XmlElement({
...
var Signature = function (_super) {
    ...
    Signature = tslib_1.__decorate([XmlCore.XmlElement({
...
var EcdsaPublicKey = function (_super) {
    ...
    EcdsaPublicKey = tslib_1.__decorate([XmlCore.XmlElement({
...
var NamedCurve = function (_super) {
    ...
    NamedCurve = tslib_1.__decorate([XmlCore.XmlElement({
...
var DomainParameters = function (_super) {
    ...
    DomainParameters = tslib_1.__decorate([XmlCore.XmlElement({
...
var EcdsaKeyValue = function (_super) {
    ...
    EcdsaKeyValue = tslib_1.__decorate([XmlCore.XmlElement({
...
var RsaKeyValue = function (_super) {
    ...
    RsaKeyValue = tslib_1.__decorate([XmlCore.XmlElement({
...
var MaskGenerationFunction = function (_super) {
    ...
    MaskGenerationFunction = tslib_1.__decorate([XmlCore.XmlElement({
...
var PssAlgorithmParams = function (_super) {
    ...
    PssAlgorithmParams = PssAlgorithmParams_1 = tslib_1.__decorate([XmlCore.XmlElement({
...
var KeyValue = function (_super) {
    ...
    KeyValue = tslib_1.__decorate([XmlCore.XmlElement({
...
var X509Certificate = function () {
    ...
    X509Certificate.prototype.exportKey = function (algorithm) {
        ...
        return Promise.resolve().then(function () {
            if (!pkijs.getCrypto()) {
                pkijs.setEngine(Application.crypto.name, new pkijs.CryptoEngine({ name: Application.crypto.name, crypto: Application.crypto }), Application.crypto.subtle);
            }
            var alg = {
                algorithm: algorithm,
                usages: ["verify"]
            ...
            if (alg.algorithm.name.toUpperCase() === ECDSA) {
                alg.algorithm.namedCurve = _this.simpl.subjectPublicKeyInfo.toJSON().crv;
            }
...
var X509IssuerSerial = function (_super) {
    ...
    X509IssuerSerial = tslib_1.__decorate([XmlCore.XmlElement({ localName: XmlSignature.ElementNames.X509IssuerSerial })], X509IssuerSerial);
...
var KeyInfoX509Data = function (_super) {
    ...
    KeyInfoX509Data = tslib_1.__decorate([XmlCore.XmlElement({
...
var SPKIData = function (_super) {
    ...
    SPKIData = tslib_1.__decorate([XmlCore.XmlElement({
...
var SignedXml = function () {
            ...
            if (reference.Uri) {
                ...
                if (!reference.Uri.indexOf("#xpointer")) {
                    ...
                    if (uri.length > 6 && uri.indexOf("id(") === 0 && uri[uri.length - 1] === ")") {
                        objectName_1 = uri.substring(4, uri.length - 2);
                    }
                } else if (reference.Uri[0] === "#") {
                    objectName_1 = reference.Uri.substring(1);
                }
                if (objectName_1) {
                    var found_1 = null;
                    if (_this.XmlSignature.ObjectList) {
                        _this.XmlSignature.ObjectList.Some(function (obj) {
                            found_1 = findById(obj.GetXml(), objectName_1);
                            if (found_1) {
                                var el = found_1.cloneNode(true);

                                _this.CopyNamespaces(doc, el, false);

                                if (_this.Parent) {
                                    var parent = _this.Parent instanceof XmlCore.XmlObject ? _this.Parent.GetXml() : _this.Parent;
                                    _this.CopyNamespaces(parent, el, true);
                                }
                                _this.CopyNamespaces(found_1, el, false);
                    ...
                    if (!found_1 && doc) {
                        found_1 = XmlCore.XmlObject.GetElementById(doc, objectName_1);
                        if (found_1) {
                            var el = found_1.cloneNode(true);
                            _this.CopyNamespaces(found_1, el, false);
                            _this.CopyNamespaces(doc, el, false);
                    ...
                    if (found_1 == null) {
                        throw new XmlCore.XmlError(XmlCore.XE.CRYPTOGRAPHIC, "Cannot get object by reference: " + objectName_1);
                    }
                }
            }
    ...
    SignedXml.prototype.TransformSignedInfo = function (data) {
        ...
        if (this.Parent) {
            var parentXml = this.Parent instanceof XmlCore.XmlObject ? this.Parent.GetXml() : this.Parent;
            if (parentXml) {

...
context("XAdES signing", function () {
    var keys;
    var alg = {
    ...
    it("Default signing (SigningTime, SignaturePolicyIdentifier)", function (done) {
        var signature = new XAdES.SignedXml();
        ...
        XAdES.Parse(xml), // document
        {
            ...
            var xades = new XAdES.SignedXml(XAdES.Parse(sig));
    ...
    it("SigningCertificate, SignatireProductionPlace, SignerRole", function (done) {
        var signature = new XAdES.SignedXml();
        signature.Sign(// Signing document
        alg, // algorithm
        keys.privateKey, // key

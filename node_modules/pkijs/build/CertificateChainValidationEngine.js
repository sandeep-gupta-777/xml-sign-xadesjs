  ...
  */
   ...
   */
				...
				return regeneratorRuntime.wrap(function _callee8$(_context8) {
					while (1) {
						switch (_context8.prev = _context8.next) {
							...
							case 106:
								if (!(_i10 < this.certs.length - 1)) {
									_context8.next = 123;
									break;
								}

								if (!(_i10 < this.certs.length - 2 && typeof policyMappings[_i10 + 1] !== "undefined")) {
									_context8.next = 120;
									break;
								}
							...
							case 109:
								if (!(_k < policyMappings[_i10 + 1].mappings.length)) {
									_context8.next = 120;
									break;
								}

								if (!(policyMappings[_i10 + 1].mappings[_k].issuerDomainPolicy === "2.5.29.32.0" || policyMappings[_i10 + 1].mappings[_k].subjectDomainPolicy === "2.5.29.32.0")) {
									_context8.next = 112;
									break;
								}
							...
							case 112:
								...
								for (n = 0; n < allPolicies.length; n++) {
									if (allPolicies[n] === policyMappings[_i10 + 1].mappings[_k].issuerDomainPolicy) issuerDomainPolicyIndex = n;

									if (allPolicies[n] === policyMappings[_i10 + 1].mappings[_k].subjectDomainPolicy) subjectDomainPolicyIndex = n;
								}
								//endregion

								//region Delete existing "issuerDomainPolicy" because on the level we mapped the policy to another one
								if (typeof policiesAndCerts[issuerDomainPolicyIndex][_i10] !== "undefined") delete policiesAndCerts[issuerDomainPolicyIndex][_i10];
								//endregion

								//region Check all policies for the certificate
								for (_j2 = 0; _j2 < certPolicies[_i10].certificatePolicies.length; _j2++) {
									if (policyMappings[_i10 + 1].mappings[_k].subjectDomainPolicy === certPolicies[_i10].certificatePolicies[_j2].policyIdentifier) {
							...
							case 123:
								...
								for (_i11 = 0; _i11 < allPolicies.length; _i11++) {
									if (allPolicies[_i11] === "2.5.29.32.0") {
										for (_j3 = 0; _j3 < explicitPolicyStart; _j3++) {
											delete policiesAndCerts[_i11][_j3];
										}
									}
								}
								//endregion
							...
							case 126:
								if (!(_i12 < policiesAndCerts.length)) {
									_context8.next = 154;
									break;
								}
							...
							case 129:
								...
								if (!(_j4 < explicitPolicyStart && allPolicies[_i12] === "2.5.29.32.0" && allPolicies.length > 1)) {
									_context8.next = 134;
									break;
								}
							...
							case 134:
								if (!(typeof policiesAndCerts[_i12][_j4] === "undefined")) {
									_context8.next = 147;
									break;
								}
							...
							case 150:
								...
								if (found === true) authConstrPolicies.push(allPolicies[_i12]);
							...
							case 164:
								if (!(_i13 < authConstrPolicies.length)) {
									_context8.next = 176;
									break;
								}
							...
							case 166:
								...
								if (!(initialPolicySet[_j5] === authConstrPolicies[_i13] || initialPolicySet[_j5] === "2.5.29.32.0")) {
									_context8.next = 170;
									break;
								}

								userConstrPolicies.push(authConstrPolicies[_i13]);
							...
							case 183:
								...
								if ("extensions" in this.certs[_i14]) {
									for (_j6 = 0; _j6 < this.certs[_i14].extensions.length; _j6++) {
										//region NameConstraints
										if (this.certs[_i14].extensions[_j6].extnID === "2.5.29.30") {
											if ("permittedSubtrees" in this.certs[_i14].extensions[_j6].parsedValue) certPermittedSubtrees = certPermittedSubtrees.concat(this.certs[_i14].extensions[_j6].parsedValue.permittedSubtrees);

											if ("excludedSubtrees" in this.certs[_i14].extensions[_j6].parsedValue) certExcludedSubtrees = certExcludedSubtrees.concat(this.certs[_i14].extensions[_j6].parsedValue.excludedSubtrees);
										}
										//endregion

										//region SubjectAltName
										if (this.certs[_i14].extensions[_j6].extnID === "2.5.29.17") subjectAltNames = subjectAltNames.concat(this.certs[_i14].extensions[_j6].parsedValue.altNames);
										//endregion
									}
								}
							...
							case 190:
								if (!(_j7 < requiredNameForms.length)) {
									_context8.next = 211;
									break;
								}

								_context8.t0 = requiredNameForms[_j7].base.type;
								_context8.next = _context8.t0 === 4 ? 194 : 208;
								break;

							case 194:
								if (!(requiredNameForms[_j7].base.value.typesAndValues.length !== this.certs[_i14].subject.typesAndValues.length)) {
									_context8.next = 196;
									break;
								}
							...
							case 198:
								if (!(_k3 < this.certs[_i14].subject.typesAndValues.length)) {
									_context8.next = 205;
									break;
								}

								if (!(this.certs[_i14].subject.typesAndValues[_k3].type !== requiredNameForms[_j7].base.value.typesAndValues[_k3].type)) {
									_context8.next = 202;
									break;
								}
							...
							case 223:
								if (!(_j8 < permittedSubtrees.length)) {
									_context8.next = 240;
									break;
								}

								_context8.t1 = permittedSubtrees[_j8].base.type;
								_context8.next = _context8.t1 === 1 ? 227 : _context8.t1 === 2 ? 229 : _context8.t1 === 4 ? 231 : _context8.t1 === 6 ? 233 : _context8.t1 === 7 ? 235 : 237;
								break;

							case 227:
								constrGroups[0].push(permittedSubtrees[_j8]);
								return _context8.abrupt("break", 237);

							case 229:
								constrGroups[1].push(permittedSubtrees[_j8]);
								return _context8.abrupt("break", 237);

							case 231:
								constrGroups[2].push(permittedSubtrees[_j8]);
								return _context8.abrupt("break", 237);

							case 233:
								constrGroups[3].push(permittedSubtrees[_j8]);
								return _context8.abrupt("break", 237);

							case 235:
								constrGroups[4].push(permittedSubtrees[_j8]);
								return _context8.abrupt("break", 237);
								...
								if (subjectAltNames.length > 0) {
									for (_k4 = 0; _k4 < subjectAltNames.length; _k4++) {
										if (subjectAltNames[_k4].type === 1) // rfc822Name
											{
												valueExists = true;
												groupPermitted = groupPermitted || compareRFC822Name(subjectAltNames[_k4].value, group[_j9].base.value);
											}
									}
								} else // Try to find out "emailAddress" inside "subject"
									{
										for (_k5 = 0; _k5 < this.certs[_i14].subject.typesAndValues.length; _k5++) {
											if (this.certs[_i14].subject.typesAndValues[_k5].type === "1.2.840.113549.1.9.1" || // PKCS#9 e-mail address
											this.certs[_i14].subject.typesAndValues[_k5].type === "0.9.2342.19200300.100.1.3") // RFC1274 "rfc822Mailbox" e-mail address
												{
													valueExists = true;
													groupPermitted = groupPermitted || compareRFC822Name(this.certs[_i14].subject.typesAndValues[_k5].value.valueBlock.value, group[_j9].base.value);
												}
										}
									}
								...
								if (subjectAltNames.length > 0) {
									for (_k6 = 0; _k6 < subjectAltNames.length; _k6++) {
										if (subjectAltNames[_k6].type === 2) // dNSName
											{
												valueExists = true;
												groupPermitted = groupPermitted || compareDNSName(subjectAltNames[_k6].value, group[_j9].base.value);
											}
									}
								}
								return _context8.abrupt("break", 261);
							...
							case 254:
								valueExists = true;
								groupPermitted = compareDirectoryName(this.certs[_i14].subject, group[_j9].base.value);
								return _context8.abrupt("break", 261);
								...
								if (subjectAltNames.length > 0) {
									for (_k7 = 0; _k7 < subjectAltNames.length; _k7++) {
										if (subjectAltNames[_k7].type === 6) // uniformResourceIdentifier
											{
												valueExists = true;
												groupPermitted = groupPermitted || compareUniformResourceIdentifier(subjectAltNames[_k7].value, group[_j9].base.value);
											}
									}
								}
								return _context8.abrupt("break", 261);
								...
								if (subjectAltNames.length > 0) {
									for (_k8 = 0; _k8 < subjectAltNames.length; _k8++) {
										if (subjectAltNames[_k8].type === 7) // iPAddress
											{
												valueExists = true;
												groupPermitted = groupPermitted || compareIPAddress(subjectAltNames[_k8].value, group[_j9].base.value);
											}
									}
								}
								return _context8.abrupt("break", 261);
							...
							case 276:
								if (!(_j10 < excludedSubtrees.length)) {
									_context8.next = 295;
									break;
								}

								_context8.t3 = excludedSubtrees[_j10].base.type;
								...
								if (subjectAltNames.length >= 0) {
									for (_k9 = 0; _k9 < subjectAltNames.length; _k9++) {
										if (subjectAltNames[_k9].type === 1) // rfc822Name
											excluded = excluded || compareRFC822Name(subjectAltNames[_k9].value, excludedSubtrees[_j10].base.value);
									}
								} else // Try to find out "emailAddress" inside "subject"
									{
										for (_k10 = 0; _k10 < this.certs[_i14].subject.typesAndValues.length; _k10++) {
											if (this.certs[_i14].subject.typesAndValues[_k10].type === "1.2.840.113549.1.9.1" || // PKCS#9 e-mail address
											this.certs[_i14].subject.typesAndValues[_k10].type === "0.9.2342.19200300.100.1.3") // RFC1274 "rfc822Mailbox" e-mail address
												excluded = excluded || compareRFC822Name(this.certs[_i14].subject.typesAndValues[_k10].value.valueBlock.value, excludedSubtrees[_j10].base.value);
										}
									}
								...
								if (subjectAltNames.length > 0) {
									for (_k11 = 0; _k11 < subjectAltNames.length; _k11++) {
										if (subjectAltNames[_k11].type === 2) // dNSName
											excluded = excluded || compareDNSName(subjectAltNames[_k11].value, excludedSubtrees[_j10].base.value);
									}
								}
								return _context8.abrupt("break", 290);

							case 284:
								excluded = excluded || compareDirectoryName(this.certs[_i14].subject, excludedSubtrees[_j10].base.value);
								return _context8.abrupt("break", 290);
								...
								if (subjectAltNames.length > 0) {
									for (_k12 = 0; _k12 < subjectAltNames.length; _k12++) {
										if (subjectAltNames[_k12].type === 6) // uniformResourceIdentifier
											excluded = excluded || compareUniformResourceIdentifier(subjectAltNames[_k12].value, excludedSubtrees[_j10].base.value);
									}
								}
								return _context8.abrupt("break", 290);
								...
								if (subjectAltNames.length > 0) {
									for (_k13 = 0; _k13 < subjectAltNames.length; _k13++) {
										if (subjectAltNames[_k13].type === 7) // iPAddress
											excluded = excluded || compareIPAddress(subjectAltNames[_k13].value, excludedSubtrees[_j10].base.value);
									}
								}
								return _context8.abrupt("break", 290);
		...
		value: function defaultFindOrigin(certificate, validationEngine) {
			...
			try {
				for (var _iterator5 = validationEngine.certs[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
					var localCert = _step5.value;
			...
			try {
				for (var _iterator6 = validationEngine.trustedCerts[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
					var trustedCert = _step6.value;

  ...
  */
   ...
   */
		...
		value: function getCertificateStatus(certificate, issuerCertificate) {
			...
			sequence = sequence.then(function () {
				...
				try {
					for (var _iterator2 = _this2.tbsResponseData.responses[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						...
						try {
							for (var _iterator3 = certIDs[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
								...
								if (_response.certID.isEqual(id)) {
									...
									try {
										switch (_response.certStatus.idBlock.isConstructed) {
											case true:
												if (_response.certStatus.idBlock.tagNumber === 1) result.status = 1; // revoked

												break;
											case false:
												switch (_response.certStatus.idBlock.tagNumber) {
													case 0:
														// good
														result.status = 0;
														break;
   ...
   */
		...
		value: function sign(privateKey) {
			...
			sequence = sequence.then(function (result) {
				_this3.signature = new asn1js.BitString({ valueHex: result });
			});
			//endregion
